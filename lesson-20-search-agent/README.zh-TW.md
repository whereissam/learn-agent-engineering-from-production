...
> [English](README.md)
>
> 前置：[Lesson 3](../lesson-03-streaming/README.zh-TW.md)（streaming）。看過 [Lesson 6](../lesson-06-domain-tools/README.zh-TW.md) 會更有感。
>
> 這是 **AI Search 篇**的第一課。
...
> 這幾個專案的原始碼還沒逐一讀過，所以上面只標「概念對應到哪個專案」，
...
[Lesson 21: Crawl 與內容抽取](../lesson-21-crawl/README.zh-TW.md)：這一課的 agent 看不到整頁。
