...
> [English](README.md)
>
> 前置：[Lesson 6](../lesson-06-domain-tools/README.zh-TW.md)。這一課直接評估那個 agent。
>
...
`real-fall` 的 400 是間歇性的。手動跑同一個 session 完全正常，
分類、時間窗都對。
...
3. 在你現在的專案裡練第 2 層。不需要做新的 agent app：
   ...
   然後要求 coding agent 每次都把那個迴圈跑完。

---

## 下一課

[Lesson 8: 從 boolean 到風險分級](../lesson-08-permissions/README.zh-TW.md)：
