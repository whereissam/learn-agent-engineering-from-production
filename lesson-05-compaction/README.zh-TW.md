...
> [English](README.md)
>
> 前置：[Lesson 4](../lesson-04-sessions/README.zh-TW.md)。引擎本體（Lesson 1-5）的最後一課。
>
...
> 這個 playground 刻意做得比 Lesson 1-4 的大很多（14 個檔案、
...
一次網路請求。但壓縮的觸發時機不需要精準，差 10% 不會怎樣。

`4` 是英文的經驗值。中文大約 1.5–2 個字元一個 token，所以這個函式對中文
會低估。這是刻意的：寧可低估而晚一點壓縮，也不要高估而過早壓縮
（過早壓縮 = 白花一次摘要的錢）。
...
[Lesson 6: 領域工具](../lesson-06-domain-tools/README.zh-TW.md)：引擎到這裡就完整了。
