...
> [English](README.md)
>
> 前置：[Lesson 21](../lesson-21-crawl/README.zh-TW.md)（fetch）、[22](../lesson-22-retrieval/README.zh-TW.md)（檢索）、
> [23](../lesson-23-real-world/README.zh-TW.md)（讀過真實專案的原始碼）。
>
...
> 兩個專案在這裡的選擇不同，這一課照 gpt-researcher 的做。
...
[Lesson 25: 引用與評估](../lesson-25-citations/README.zh-TW.md)：這一課的每條證據都掛著網址，
但**沒有人檢查那一頁真的說了那句話**。
