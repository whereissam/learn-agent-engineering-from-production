...
> [English](README.md)
>
> Hermes 篇第四課。前置：[Lesson 9](../lesson-09-unattended/README.zh-TW.md)（無人值守與 inbox）、
> [Lesson 4](../lesson-04-sessions/README.zh-TW.md)（session）。
>
...
真的接上去就是 [Lesson 35](../docs/TODO.zh-TW.md) 的題目。
...
> `cron/scheduler.py` 有 4298 行，這一課的 `scheduler.ts` 不到 150 行。
...
下一課是 [Lesson 19: 把任務交出去](../lesson-19-delegation/README.zh-TW.md) ——
