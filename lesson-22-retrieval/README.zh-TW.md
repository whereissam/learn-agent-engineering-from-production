...
> [English](README.md)
>
> 前置：[Lesson 20](../lesson-20-search-agent/README.zh-TW.md)（BM25 baseline）、
> [Lesson 21](../lesson-21-crawl/README.zh-TW.md)（fetch_page）。
>
...
第 4 題和第 5 題的答案都是實測出來的，而且都跟事前的預期不一樣。
...
語料的 `pages.ts` 裡有一個 `kind: "spam"` 欄位，排序時大可以直接讀它，
...
如果沒有逐題的表格，0.768 就會很開心地被寫進 README，
...
| 確定性評分、逐題回歸 | 本系列 [Lesson 7](../lesson-07-evaluation/README.zh-TW.md) |

> 這幾個專案的原始碼還沒逐一讀過，只標概念對應（設計原則 4）。
...
[Lesson 23: 對照真實原始碼](../lesson-23-real-world/README.zh-TW.md)：Step 8 那個
...
> [docs/TODO.md](../docs/TODO.zh-TW.md)：拆開來看，「包成服務」裡真正在學
